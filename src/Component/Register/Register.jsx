...
<input onBlur={totalFormik.handleBlur} onChange={totalFormik.handleChange} value={totalFormik.values.password} id='password' type="password" className='form-control mb-2' placeholder='Password' />
...
<input onBlur={totalFormik.handleBlur} onChange={totalFormik.handleChange} value={totalFormik.values.rePassword} id='rePassword' type="password" className='form-control mb-2' placeholder='RePassword' />
